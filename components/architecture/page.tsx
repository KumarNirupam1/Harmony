    ...
    <div className="flex min-h-full flex-1 flex-col bg-background">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 pt-20 pb-16">
        ...
        <p className="mt-4 text-muted leading-7">
          ...
          mission, then paints the intercept map, both strategies, and the KPIs.
        </p>
        ...
        <ol className="mt-10 space-y-4">
          {[
            ...
            [
              "Solve",
              "API Gateway fronts a Lambda container. The engine unrolls RK4 advection, then backprops capture versus control effort through every hour.",
            ],
            [
              "Compare",
              "The response carries a velocity sample plus random and Harmony trajectories. The map scrubs boats and debris on the same gyre.",
            ],
            [
              "Judge",
              "Metrics are server-computed: recovered debris, control effort, efficiency gain. The UI only counts them up.",
            ],
          ].map(([title, body], i) => (
